...
import com.xqs.datedemo.util.AnimationUtils;
...
public abstract class BaseAdapter<T> extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public void addHeaderViewResId(int layoutResId, ViewGroup parentView) {
        addHeaderView(mInflater.inflate(layoutResId, parentView, false));
    }
