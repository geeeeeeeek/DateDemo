...
import com.xqs.datedemo.adapter.AnimationType;


/**
 * Created by Yat3s on 24/02/2017.
...
public class AnimationUtils {
    ...
    public AnimationUtils setAnimationType(AnimationType animationType) {
        mAnimationType = animationType;
        return this;
    }

    public AnimationUtils setCustomAnimation(Animator animator) {
        mCustomAnimator = animator;
        return this;
    }

    public AnimationUtils setDuration(int duration) {
        mDuration = duration;
        return this;
    }
    ...
    public AnimationUtils setTargetView(View targetView) {
